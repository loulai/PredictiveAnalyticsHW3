...
/**
 * The Dataset class is essentially a Matrix (i.e. a 2D array of doubles)
 * It is used to represent the TFIDF dataset in a format
 * that is suitable to conduct SVD and compare results to JavaML
...
public class Dataset {
	...
	public void printMatrix() {
	  ...
	  /**
	   *  Prints a matrix to CSV
	   *  Recommended format: observations as rows, attributes as columns
	   */
	  public void printToCSV(String filename) {
		...
		for(int i = 0; i < numRows; i++) {
			...
			// Print article names in the first column
